...
| Стабильных tracked-файлов | 6,424 |
| Строк | 618,495 |
| Размер | 25.26 MiB |
| Python-файлов | 3,563 |
| Строк Python | 367,226 |
| Классов / функций / async | 3,063 / 20,361 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 991 / 6,903 |
| Markdown-файлов | 2,057 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 987 | 160,385 | 6.01 MiB |
| `skills` | 2,641 | 109,481 | 4.73 MiB |
| `docs` | 482 | 76,348 | 3.29 MiB |
| `tests` | 573 | 73,382 | 2.56 MiB |
| `[root]` | 220 | 35,788 | 1.43 MiB |
