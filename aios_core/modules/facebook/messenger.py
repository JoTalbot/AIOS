"""Facebook Messenger (Marketplace) — guarded-обёртка HintsMessenger.
...
DEEP_LINK = "fb://messaging"


class FacebookMessenger(HintsMessenger):
    """Facebook messenger по calibrated hints (parser_hints.messenger)."""
