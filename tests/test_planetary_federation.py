...
def test_planetary_mesh_routing():
    ...
    route_fast = mesh.route_planetary_task(
        {"id": "task_fast", "payload": "realtime_control"}, max_allowed_latency_ms=30.0
    )
    ...
    route_space = mesh.route_planetary_task(
        {"id": "task_space", "payload": "lunar_geology_analysis"}, max_allowed_latency_ms=2000.0
    )
