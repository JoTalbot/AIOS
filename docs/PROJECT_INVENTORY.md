...
| Стабильных tracked-файлов | 6,503 |
| Строк | 622,339 |
| Размер | 25.40 MiB |
| Python-файлов | 3,627 |
| Строк Python | 370,402 |
| Классов / функций / async | 3,134 / 20,548 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 1,010 / 6,956 |
| Markdown-файлов | 2,072 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 1,031 | 162,179 | 6.07 MiB |
| `skills` | 2,654 | 109,927 | 4.76 MiB |
| `docs` | 484 | 76,539 | 3.30 MiB |
| `tests` | 592 | 74,501 | 2.59 MiB |
