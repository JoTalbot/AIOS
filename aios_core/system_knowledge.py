...
NL_COMMANDS: list[tuple[str, str]] = [
    ...
    # Единый инбокс
    ("Инбокс",
     "«инбокс», «все сообщения», «всё в одном», «сводка сообщений», «где что новое», "
     "«проверь всё», «озвучь инбокс», «прочитай инбокс вслух», «найди во всех чатах <запрос>», "
     "«ответь на 3: текст», «отметь всё прочитанным», «присылай инбокс в HH:MM», "
     "«расписание инбокса»"),
    # Напоминания
    ("Напоминания",
