#!/usr/bin/env python3
"""Contract tests for github-actions-health-reader skill."""
...
def test_run_py_not_generic_runtime():
    ...
    assert "check_runner_status" in code or "REPO" in code
...
def test_run_produces_valid_json():
    ...
    assert data.get("skill") == "github-actions-health-reader"
