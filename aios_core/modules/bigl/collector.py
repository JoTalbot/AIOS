"""Bigl.ua collector — ADB-driven product collection."""
...
class BiglCollector:
    ...
    Reuses OLXCollector pattern with Bigl-specific card markers.
    """
    ...
    def search_deep_link(query: str) -> str:
        """Generate a bigl://search deep link."""
        return f"bigl://search?q={query}"
