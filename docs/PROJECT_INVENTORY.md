...
| Стабильных tracked-файлов | 6,102 |
| Строк | 557,414 |
| Размер | 22.23 MiB |
| Python-файлов | 3,381 |
| Строк Python | 339,236 |
| Классов / функций / async | 2,960 / 19,182 / 1,631 |
| Python syntax errors | 0 |
| Test Python files / test functions | 926 / 6,545 |
| Markdown-файлов | 1,977 |
| Root `run_*.py` | 113 |
