...
| Стабильных tracked-файлов | 6,082 |
| Строк | 556,136 |
| Размер | 22.18 MiB |
| Python-файлов | 3,368 |
| Строк Python | 338,083 |
| Классов / функций / async | 2,955 / 19,123 / 1,630 |
| Python syntax errors | 0 |
| Test Python files / test functions | 919 / 6,534 |
...
|---|---:|---:|---:|
| `aios_core` | 969 | 157,765 | 5.90 MiB |
| `skills` | 2,641 | 109,481 | 4.73 MiB |
| `tests` | 493 | 66,335 | 2.29 MiB |
