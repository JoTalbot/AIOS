...
NL_COMMANDS: list[tuple[str, str]] = [
    ...
    # Единый инбокс
    ("Инбокс",
     "«инбокс» — все каналы, «инбокс чаты» — только мессенджеры (TG, Direct, Messenger, Viber, Signal), "
     "«инбокс тг» — только Telegram, «инбокс тг и инста» — несколько каналов, «инбокс почта» — только почта, "
     "«инбокс вайбер», «инбокс олх», «инбокс телефон», «инбокс только непрочитанное». "
     "Из мессенджеров в инбокс попадают только ЛИЧНЫЕ переписки (без групп и каналов). "
     "«озвучь инбокс», «найди во всех чатах <запрос>», «ответь на 3: текст», «отметь всё прочитанным», "
     "«присылай инбокс в HH:MM», «расписание инбокса»"),
    # Напоминания
    ("Напоминания",
