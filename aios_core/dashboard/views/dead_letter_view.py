...
def render_dead_letter_view():
    ...
    ui.table(
        ...
        rows=[
            {"id": "1", "platform": "instagram", "error": "Connection timeout", "timestamp": "2026-07-27 10:30:00", "actions": "retry"},
            {"id": "2", "platform": "olx", "error": "Invalid signature", "timestamp": "2026-07-27 11:15:00", "actions": "retry"}
        ],
        row_key="id"
    ).classes("w-full")
