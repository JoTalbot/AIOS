...
class TestExportImportE2E:
    ...
    def test_export_import_cycle(self, client, tmp_path):
        ...
        # Import data
        response = client.post("/api/v1/admin/import", json={
            "type": "tasks",
            "format": "json",
...
class TestAPIKeysE2E:
    ...
    def test_key_export_import(self, client, tmp_path):
        ...
        response = client.post("/api/v1/admin/keys/export", json={
...
class TestWebhooksE2E:
    ...
    def test_full_webhook_lifecycle(self, client):
        ...
        # Unregister webhook
        response = client.post("/api/v1/admin/webhooks/unregister", json={
            "name": "test-webhook",
        })
