                ...
                response = await client.post(
                    ...
                    json={
                        ...
                        "messages": [
                            {
                                "role": "system",
                                "content": f'Ты ассистент. Определи намерение (intent) сообщения. Доступные intents: {intents_list}. Ответь строго в формате JSON: {{"intent": "...", "confidence": 0.9, "reasoning": "..."}}',
                            },
