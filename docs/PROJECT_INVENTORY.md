...
| Стабильных tracked-файлов | 6,489 |
| Строк | 621,731 |
| Размер | 25.38 MiB |
| Python-файлов | 3,615 |
| Строк Python | 369,874 |
| Классов / функций / async | 3,118 / 20,514 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 1,008 / 6,951 |
| Markdown-файлов | 2,070 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 1,021 | 161,798 | 6.06 MiB |
| `skills` | 2,652 | 109,874 | 4.76 MiB |
| `docs` | 484 | 76,512 | 3.30 MiB |
| `tests` | 590 | 74,354 | 2.59 MiB |
