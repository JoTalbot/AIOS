...
| Стабильных tracked-файлов | 6,099 |
| Строк | 557,230 |
| Размер | 22.22 MiB |
| Python-файлов | 3,379 |
| Строк Python | 339,062 |
| Классов / функций / async | 2,959 / 19,173 / 1,631 |
| Python syntax errors | 0 |
| Test Python files / test functions | 925 / 6,544 |
