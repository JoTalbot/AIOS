...
class PlanetaryMeshOrchestrator:
    ...
    def __init__(self):
        ...
        self.register_node(
            "lunar_gateway_edge",
            "lunar_edge",
            latency_to_earth_ms=1300.0,
            bandwidth_mbps=20.0,
            energy_capacity_wh=5000.0,
        )
        self.register_node(
            "mars_perseverance",
            "deep_space",
            latency_to_earth_ms=840000.0,
            bandwidth_mbps=2.0,
    ...
    def route_planetary_task(
        ...
        eligible_nodes = [
            n for n in self.nodes.values() if n.is_reachable() and n.latency_to_earth_ms <= max_allowed_latency_ms
        ]
    ...
    def stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "energy_critical_nodes": sum(
                1
                for n in self.nodes.values()
                if n.energy_capacity_wh > 0 and (n.energy_consumed_wh / n.energy_capacity_wh) > 0.8
            ),
        }
