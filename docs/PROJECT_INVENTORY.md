...
| Стабильных tracked-файлов | 6,105 |
| Строк | 557,573 |
| Размер | 22.24 MiB |
| Python-файлов | 3,383 |
| Строк Python | 339,385 |
| Классов / функций / async | 2,960 / 19,187 / 1,631 |
| Python syntax errors | 0 |
| Test Python files / test functions | 927 / 6,546 |
| Markdown-файлов | 1,978 |
| Root `run_*.py` | 113 |
