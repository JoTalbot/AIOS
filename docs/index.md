...
**Версия:** 10.15.0 | **Тесты:** 1255 passed (локальный аудит, 23 июля 2026)
...
- **REST API** — Starlette-приложение, раскрывающее подсистемы рантайма (169 маршрутов)
...
| Метрика | Значение |
|---------|----------|
| Тесты | **1255 passed** (последний локальный аудит) |
| API маршруты | **169** ✅ |
