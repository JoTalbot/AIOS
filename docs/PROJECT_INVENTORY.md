...
| Стабильных tracked-файлов | 6,500 |
| Строк | 622,153 |
| Размер | 25.39 MiB |
| Python-файлов | 3,625 |
| Строк Python | 370,258 |
| Классов / функций / async | 3,130 / 20,538 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 1,009 / 6,954 |
| Markdown-файлов | 2,071 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 1,030 | 162,110 | 6.07 MiB |
| `skills` | 2,653 | 109,901 | 4.76 MiB |
| `docs` | 484 | 76,523 | 3.30 MiB |
| `tests` | 591 | 74,426 | 2.59 MiB |
