...
- `docs/` — Architecture, agent, memory, testing and application docs. `docs/constitution/` holds articles I–LXVII; `docs/executable_layer/` holds the AIOS v2.1.1 layer manifests (architecture, roadmap, changelog, compliance, deployment, etc.); `docs/aios_v6/` holds the AIOS v6 / v6.1 "Global Federation" specification docs (architecture, agent framework, memory, federation protocols, QA kernel, roadmaps) merged from `AIOS.zip`.
