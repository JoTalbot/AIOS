...
Для тем с альтернативными версиями сгенерированы **синтезированные** документы
`<canon>.merged.md` — канон как основа + уникальные разделы/пункты из вариантов.
Список и статистика — в `MERGED_INDEX.md` (см. `tools/synthesize_merged_docs.py`).
