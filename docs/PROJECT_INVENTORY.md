...
| Стабильных tracked-файлов | 6,487 |
| Строк | 621,541 |
| Размер | 25.37 MiB |
| Python-файлов | 3,614 |
| Строк Python | 369,710 |
| Классов / функций / async | 3,116 / 20,507 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 1,008 / 6,949 |
| Markdown-файлов | 2,069 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 1,020 | 161,699 | 6.05 MiB |
| `skills` | 2,651 | 109,849 | 4.75 MiB |
| `docs` | 484 | 76,511 | 3.30 MiB |
| `tests` | 590 | 74,289 | 2.58 MiB |
| `[root]` | 220 | 35,819 | 1.44 MiB |
