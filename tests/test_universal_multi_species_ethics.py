...
def test_multi_species_ethics_evaluation():
    ...
    res_safe = ethics.evaluate_multi_species_impact(
        safe_op, affected_entities=["planetary_biosphere"]
    )
    ...
    res_risky = ethics.evaluate_multi_species_impact(
        risky_op, affected_entities=["planetary_biosphere"]
    )
