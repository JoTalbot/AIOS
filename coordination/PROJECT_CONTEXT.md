...
1. Directional v2 paper: входы пошли (1 сделка в каждом контуре на 17.08);
   ...
   после ≥30 сделок.
2. MM: interim-2 и модель очереди (17.08) негативны — см. блок «Где закончили»;
   финальный вердикт после полных 2-4 недель 1Гц; приоритет очереди — на
   100мс-стриме BTC/ETH; maker-rebate проверка для BNB.
