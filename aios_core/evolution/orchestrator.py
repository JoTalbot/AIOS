...
class EvolutionOrchestrator:
    ...
    async def run_cycle(self):
        ...
        try:
            results["evolved"] = (
                await template_evolution.auto_evolve_all() if hasattr(template_evolution, "auto_evolve_all") else []
            )
        ...
        for evo in results.get("evolved", []):
            ...
            await notify_template_promoted(
                evo.get("template_id", ""), evo.get("old_version", 0), evo.get("new_version", 1)
            )
