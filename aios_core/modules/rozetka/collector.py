"""Rozetka.ua collector — automated scrolling card collection via ADB."""
...
class RozetkaCollector:
    """Dumps the visible UI, parses product cards, swipes down, repeats.

    Reuses OLXCollector pattern with Rozetka-specific card markers.
    ...
    def search_deep_link(query: str) -> str:
        """Generate a rozetka://search deep link."""
        return f"rozetka://search?q={query}"
    ...
    def collect(
        ...
        """Collect product cards by scrolling through search results.
