...
class IntegrationMonitor:
    ...
    def __init__(self):
        self.integration_metrics = defaultdict(lambda: {
            'requests': MetricCounter("integration_requests", f"Requests for {integration}"),
            'errors': MetricCounter("integration_errors", f"Errors for {integration}"),
            'response_time': MetricHistogram("integration_response_time", f"Response time for {integration}"),
            'last_activity': MetricGauge("integration_last_activity", f"Last activity for {integration}"),
        })
