...
def render_marketplace_view():
    ...
    plugins = [
        {"name": "Avito Adapter", "author": "AIOS Team", "rating": 4.8, "installs": 1200, "price": "Free", "desc": "Full integration with Avito.ru messaging"},
        {"name": "Advanced Analytics", "author": "DataCorp", "rating": 4.5, "installs": 450, "price": "$29/mo", "desc": "Deep dive metrics and predictive churn analysis"},
        {"name": "CRM Sync (HubSpot)", "author": "Integrations Inc", "rating": 4.9, "installs": 890, "price": "$49/mo", "desc": "Two-way sync with HubSpot contacts and deals"},
    ]
