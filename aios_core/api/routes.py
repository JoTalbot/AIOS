...
def register_routes(api) -> list:
    ...
    routes = [
        ...
        Route("/api/alert-history", api._dashboard_alert_history),
        ...
        Route("/api/service/action", api._service_action, methods=["POST"]),
        ...
        Route("/api/platforms", api._platforms_list),
        Route("/api/safety", api._ui_safety),
        Route("/api/memories", api._dashboard_memories),
        Route("/api/fleet", api._dashboard_fleet),
        Route("/api/processes", api._dashboard_processes),
        Route("/api/workflows", api._dashboard_workflows),
        Route("/api/chat", api._dashboard_chat, methods=["GET", "POST"]),
        Route("/api/olx/queries", api._dashboard_olx_queries),
        Route("/api/olx/analytics", api._dashboard_olx_analytics),
        ...
        Route(
            "/api/v1/profiles/{platform}/{name}",
            api._profiles_remove,
            methods=["DELETE"],
        ),
        Route(
            "/api/v1/profiles/{platform}/default",
            api._profiles_set_default,
            methods=["POST"],
        ),
        ...
        Route("/api/v1/phone/uklon/status", api._uklon_status, methods=["GET"]),
        Route("/api/v1/phone/uklon/route-drafts", api._uklon_route_drafts_list, methods=["GET"]),
        ...
        Route(
            ...
            api._module_outbox_send,
            methods=["POST"],
        ),
        Route(
            "/api/v1/modules/{platform}/outbox/flush",
            api._module_outbox_flush,
            methods=["POST"],
        ),
