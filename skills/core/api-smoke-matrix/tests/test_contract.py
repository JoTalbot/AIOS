#!/usr/bin/env python3
"""Contract tests for api-smoke-matrix skill."""
...
def test_run_py_not_generic_runtime():
    ...
    assert "test_endpoint" in code or "ENDPOINTS" in code
...
def test_run_produces_valid_json():
    ...
    assert data.get("skill") == "api-smoke-matrix"
    assert "endpoints_tested" in data
