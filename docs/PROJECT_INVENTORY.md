...
| Стабильных tracked-файлов | 6,451 |
| Строк | 619,825 |
| Размер | 25.31 MiB |
| Python-файлов | 3,582 |
| Строк Python | 368,160 |
| Классов / функций / async | 3,080 / 20,425 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 996 / 6,918 |
| Markdown-файлов | 2,065 |
| Root `run_*.py` | 113 |
...
| `skills` | 2,648 | 109,752 | 4.75 MiB |
| `docs` | 483 | 76,442 | 3.30 MiB |
| `tests` | 578 | 73,706 | 2.57 MiB |
