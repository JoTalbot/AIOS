...
| Стабильных tracked-файлов | 6,484 |
| Строк | 621,350 |
| Размер | 25.36 MiB |
| Python-файлов | 3,612 |
| Строк Python | 369,548 |
| Классов / функций / async | 3,113 / 20,500 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 1,007 / 6,946 |
| Markdown-файлов | 2,068 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 1,019 | 161,602 | 6.05 MiB |
| `skills` | 2,650 | 109,820 | 4.75 MiB |
| `docs` | 484 | 76,511 | 3.30 MiB |
| `tests` | 589 | 74,224 | 2.58 MiB |
