#!/usr/bin/env python3
"""Contract tests for log-retention-audit skill."""
...
def test_run_py_not_generic_runtime():
    ...
    assert "check_logrotate" in code or "LOG_DIRS" in code
...
def test_run_produces_valid_json():
    ...
    assert data.get("skill") == "log-retention-audit"
    assert "dir_sizes" in data
