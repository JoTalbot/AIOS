...
| Стабильных tracked-файлов | 6,427 |
| Строк | 618,717 |
| Размер | 25.27 MiB |
| Python-файлов | 3,564 |
| Строк Python | 367,289 |
| Классов / функций / async | 3,065 / 20,363 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 992 / 6,905 |
