...
| Стабильных tracked-файлов | 6,480 |
| Строк | 621,058 |
| Размер | 25.35 MiB |
| Python-файлов | 3,609 |
| Строк Python | 369,290 |
| Классов / функций / async | 3,109 / 20,485 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 1,006 / 6,942 |
| Markdown-файлов | 2,067 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 1,017 | 161,420 | 6.04 MiB |
| `skills` | 2,649 | 109,791 | 4.75 MiB |
| `docs` | 484 | 76,506 | 3.30 MiB |
| `tests` | 588 | 74,148 | 2.58 MiB |
