...
| Стабильных tracked-файлов | 6,322 |
| Строк | 607,939 |
| Размер | 24.79 MiB |
| Python-файлов | 3,493 |
| Строк Python | 358,255 |
| Классов / функций / async | 2,984 / 19,808 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 952 / 6,643 |
| Markdown-файлов | 2,037 |
| Root `run_*.py` | 113 |
...
| `docs` | 468 | 75,588 | 3.24 MiB |
| `tests` | 534 | 70,188 | 2.44 MiB |
| `[root]` | 217 | 35,059 | 1.38 MiB |
| `scripts` | 270 | 31,561 | 1.20 MiB |
