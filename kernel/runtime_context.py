...
class RuntimeContext:
    ...
    def services(self):
        return {"kernel": self.kernel, "agent_manager": self.agent_manager, "bootstrap": self.bootstrap, "registry": self.registry, "event_bus": self.event_bus, "persistence": self.persistence, "supervisor": self.supervisor, "orchestrator": self.orchestrator}
