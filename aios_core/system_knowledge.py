...
NL_COMMANDS: list[tuple[str, str]] = [
    ...
    ("Инбокс",
     ...
     "Из мессенджеров — только ЛИЧНЫЕ переписки (без групп и каналов). Кнопка «🔄 Обновить» "
     "пересобирает из каналов; сбор новых сообщений происходит автоматически каждые 5 минут. "
     "Почта вынесена в отдельную команду: «почта» или «проверь почту». "
     "«озвучь инбокс», «найди во всех чатах <запрос>», «ответь на 3: текст», "
