...
def main():
    ...
    parser.add_argument("--simulate-2weeks", action="store_true", help="Simulate 14 days x 24 cycles in accelerated mode")
    ...
    parser.add_argument("--interval", type=int, default=900, help="Interval seconds for daemon (default 900 = 15min)")
