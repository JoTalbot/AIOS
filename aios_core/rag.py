...
class RAGSystem:
    ...
    def __init__(self, vector_store: Any = None, chunk_size: int = 500,
                 top_k: int = 5) -> None:
    ...
    def index_document(self, doc_id: str, text: str,
        ...
        for i in range(0, len(words), self.chunk_size):
            ...
            chunk = DocumentChunk(
                doc_id=doc_id, chunk_id=i // self.chunk_size,
                text=chunk_text, metadata=metadata or {},
                start_offset=i, end_offset=i + len(chunk_text),
            )
        ...
        for chunk in self.chunks:
            ...
            if total_score > 0:
                scored.append({
                    ...
                    "text": chunk.text, "score": round(total_score, 4),
