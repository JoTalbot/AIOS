...
| Стабильных tracked-файлов | 6,083 |
| Строк | 556,181 |
| Размер | 22.18 MiB |
| Python-файлов | 3,369 |
| Строк Python | 338,128 |
| Классов / функций / async | 2,956 / 19,126 / 1,630 |
| Python syntax errors | 0 |
| Test Python files / test functions | 920 / 6,535 |
| Markdown-файлов | 1,973 |
| Root `run_*.py` | 113 |
...
|---|---:|---:|---:|
| `aios_core` | 969 | 157,785 | 5.91 MiB |
| `skills` | 2,641 | 109,481 | 4.73 MiB |
| `tests` | 494 | 66,360 | 2.29 MiB |
| `docs` | 404 | 44,690 | 1.42 MiB |
| `[root]` | 217 | 35,021 | 1.38 MiB |
| `attic` | 33 | 30,669 | 1.61 MiB |
| `octopus_services` | 110 | 27,850 | 0.90 MiB |
| `scripts` | 176 | 15,569 | 0.59 MiB |
