...
class TestTaskStep:
    ...
    def test_task_step_creation(self):
        ...
        step = TaskStep(id="step-1", name="Test Step", description="Test description")
    ...
    def test_task_step_with_parameters(self):
        ...
        step = TaskStep(id="step-2", name="Parameterized Step", parameters={"key": "value"})
...
class TestTask:
    ...
    def test_task_creation(self):
        ...
        task = Task(id="task-1", name="Test Task", description="Test description")
    ...
    def test_task_with_steps(self):
        ...
        task = Task(id="task-2", name="Multi-step Task", steps=[step1, step2])
    ...
    def test_task_to_dict(self):
        ...
        task = Task(id="task-4", name="Serialization Test", steps=[step])
...
class TestOrchestrator:
    ...
    def test_create_task(self, orchestrator):
        ...
        task = orchestrator.create_task(
            task_id="task-1", name="Orchestrator Task", description="Created via orchestrator"
        )
    ...
    def test_get_task(self, orchestrator):
        """Test getting a task."""
        # Create task
        orchestrator.create_task(task_id="task-2", name="Get Test")
    ...
    def test_list_tasks(self, orchestrator):
        ...
        for i in range(5):
            orchestrator.create_task(task_id=f"task-{i}", name=f"Task {i}")
    ...
    def test_delete_task(self, orchestrator):
        ...
        # Create task
        orchestrator.create_task(task_id="task-delete", name="Delete Test")
