#!/usr/bin/env python3
"""Contract tests for backup-gap-analyzer skill."""
...
def test_run_py_not_generic_runtime():
    ...
    assert "check_path_backup_freshness" in code or "CRITICAL_PATHS" in code
...
def test_run_produces_valid_json():
    ...
    assert data.get("skill") == "backup-gap-analyzer"
