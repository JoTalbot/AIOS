...
| Стабильных tracked-файлов | 6,328 |
| Строк | 608,634 |
| Размер | 24.82 MiB |
| Python-файлов | 3,497 |
| Строк Python | 358,846 |
| Классов / функций / async | 2,984 / 19,833 / 1,636 |
| Python syntax errors | 0 |
| Test Python files / test functions | 954 / 6,651 |
| Markdown-файлов | 2,039 |
| Root `run_*.py` | 113 |
...
| `docs` | 470 | 75,692 | 3.24 MiB |
| `tests` | 536 | 70,310 | 2.44 MiB |
| `[root]` | 217 | 35,059 | 1.38 MiB |
| `scripts` | 272 | 32,030 | 1.21 MiB |
